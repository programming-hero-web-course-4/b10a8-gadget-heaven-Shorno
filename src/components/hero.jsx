                ...
                <div className={"bg-purple-600 w-11/12 mx-auto my-8 text-white rounded-2xl pb-96 relative"}>
                    ...
                    <div className={"flex flex-col justify-center items-center text-center"}>
                        <div className={"max-w-screen-lg flex flex-col justify-center items-center gap-8"}>
                            ...
                            <p className={"leading-relaxed inline-block max-w-screen-md text-lg"}>Explore the latest
                                gadgets
                        ...
                        <div
                            className={"p-4 border border-white rounded-3xl bg-white/20 w-9/12 absolute bottom-0 translate-y-1/2"}>
                            <div className={""}>
                                <img className={"rounded-3xl w-full h-[35rem] object-center"} src={Banner}
                                     alt="banner"/>
                            </div>
                        </div>
                    </div>
